...
Build your React.js application anytime after fetching your design from Figma. If your Figma design has prototyping, then that would be auto-implemented to create actions and navigations, which you can see on the generated code file when you build the app.

Watch how to Import your source code to IDE & check the code.

<iframe width="100%" height="500" src="https://www.youtube.com/embed/Dwf6hGk71rc?start=402" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## Build app to generate code

All the design has been generated with <a href="https://tailwindcss.com/" target="_blank">tailwindcss</a>. Find all the theme related configuration inside tailwind.config.js

![Example banner](./img/ReactBuildApp.gif)

## Download the source code or sync it to GitHub or GitLab

You will be redirected to the code screen and from there you can download the source code and sync it to <a href="/docs/react/deploy-on-vercel#sync-application-code-to-github">GitHub</a> & <a href="/docs/react/deploy-on-vercel#sync-application-code-to-gitlab">GitLab</a> !
